...
const breadSchema = new Schema ({
  ...
  baker: {
  type: Schema.Types.ObjectId,       // //Schema.Types.ObjectID,  //defines a field in a schema that will hold an ObjectID to ref a document in the 'Baker' collection 
  ref: 'Baker'                       // //adding a ref to the Baker model
  } 
...
breadSchema.methods.getBakedBy = function(){
  return `${this.name} was baked with love by ${this.baker.name}, who has been with us since ${this.baker.startDate.getFullYear()}`        // returns a sentence
}
